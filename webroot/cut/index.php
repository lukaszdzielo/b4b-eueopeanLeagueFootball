...
<main>
    ...
    <div class="container-fluid pt-8 px-sm-8 px-md-12 overflow-hidden">
        <div class="row g-4 align-items-center mb-8">
            ...
            <div class="col-auto">
                <button class="btn btn-gray-550">
                    <span class="me-auto">See full list</span>
                    <svg class="icon arrow" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z"/></svg>
                </button>
            </div>
        </div>
        <div class="row g-10 gx-xxl-30 pb-16">
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/barcelona_dragons.svg" alt="#">
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/berlin_thunder.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/cologne_centurions.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/frankfurt_galaxy.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/hamburg_sea_devils.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/leipzig_kings.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/wroclaw_panthers.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/raiders_tirol.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/rhein_fire.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-auto">
                <div class="team-short">
                    ...
                    <div class="image">
                        <img src="../files/teams/vienna_vikings.svg" alt="#">
                        <a href="#" class="stretched-link"></a>
                    </div>
                    <ul class="list-unstyled">
                        <li><span>Players In Team:</span><span class="score">75</span></li>
